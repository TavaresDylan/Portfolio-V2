...
<section>
	...
	<article id="contact">
		...
		<div id="logos_contact">
			<a href="https://www.instagram.com/dylan.03100/" target="blank"><img id="logoinsta"src="assets/img/icon-instagram-96.png" alt="Logo Insta"title="Redirection Instagram"></a>

			<a href="https://www.facebook.com/dylan.tavares.9" target="blank"><img id="logofacebook" src="assets/img/icon-facebook-96.png" alt="Logo Facebook" title="Redirection Facebook"></a>

			<a href="https://github.com/TavaresDylan" target="blank"><img id="logogithub"src="assets/img/icon-github-2-96.png" alt="logo gitub" title="Redirection Github"></a>
		</div>
